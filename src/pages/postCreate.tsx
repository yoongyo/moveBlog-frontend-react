        ...
        <div className="flex flex-col min-h-screen">
            ...
            <div className="max-w-4xl mx-auto py-12 flex-1 w-full px-6">
                ...
                <div className="buttons flex my-1 py-3">
                    ...
                    <button className="btn border border-secondary p-1 px-4 font-semibold cursor-pointer ml-2 bg-primary text-fakeWhite" type="button" onClick={onClick}>Post</button>
                </div>
            </div>
            <Footer/>
        </div>
